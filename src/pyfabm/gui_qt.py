...
class Delegate(QtWidgets.QStyledItemDelegate):
    ...
    def createEditor(self, parent, option, index):
        ...
        if not isinstance(data, str):
            ...
            if options is not None:
                ...
                return widget
            elif isinstance(data.value, (float, np.ndarray)):
    ...
    def setEditorData(self, editor, index):
        if isinstance(editor, QtWidgets.QComboBox):
            ...
            data = index.internalPointer().object
            editor.setValue(float(data.value))
            return
...
class Entry(object):
    def __init__(self, object=None, name: str=""):
    ...
    def addTree(self, arr: Sequence[pyfabm.Variable], category=None):
        for variable in arr:
