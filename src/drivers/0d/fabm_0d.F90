...
!BOP
!
! !MODULE: 0D driver for the Framework for Aquatic Biogeochemical Models (FABM)
!
! !INTERFACE:
   module fabm_0d
!
! !DESCRIPTION:
! This driver uses routines from the General Ocean Turbulence Model
! for dealing with date and time, calculating light intensity according to
! astronomic formulae, reading observations and performing time-integration.
!
! !USES:
   use time
   use fabm
