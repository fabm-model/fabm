...
!  create namelist
   namelist /pclake_phytoplankton_water/ sDDiatW_initial,sPDiatW_initial,sNDiatW_initial,sDGrenW_initial,sPGrenW_initial,sNGrenW_initial,  &
...
!  Read parameters namelist
   if (configunit>0) read(configunit,nml=pclake_phytoplankton_water,err=99,end=100)
...
99  call self%fatal_error('pclake_phytoplankton_water_init','Error reading namelist pclake_phytoplankton_water')

100 call self%fatal_error('pclake_phytoplankton_water_init','Namelist pclake_phytoplankton_water was not found.')
