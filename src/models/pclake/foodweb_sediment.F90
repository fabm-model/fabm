...
!  create namelist
   namelist /pclake_foodweb_sediment/ sDBent_initial,sPBent_initial,sNBent_initial, &
...
!  Read parameters namelist
   if (configunit>0) read(configunit,nml=pclake_foodweb_sediment,err=99,end=100)
...
99 call self%fatal_error('pclake_foodweb_sediment_init','Error reading namelist pclake_foodweb_sediment')

100 call self%fatal_error('pclake_foodweb_sediment_init','Namelist pclake_foodweb_sediment was not found.')
