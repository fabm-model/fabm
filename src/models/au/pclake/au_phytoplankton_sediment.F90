...
!  create namelist
!----------------------------------------------------------------------------
   namelist /au_pclake_phytoplankton_sediment/ sDDiatS_initial,sPDiatS_initial,sNDiatS_initial,sDGrenS_initial,sPGrenS_initial,sNGrenS_initial,& 
...
!  Read parameters namelist
   if (configunit>0) read(configunit,nml=au_pclake_phytoplankton_sediment,err=99,end=100)
...
99 call self%fatal_error('au_pclake_phytoplankton_sediment_init','Error reading namelist au_pclake_phytoplankton_sediment')

100 call self%fatal_error('au_pclake_phytoplankton_sediment_init','Namelist au_pclake_phytoplankton_sediment was not found.')
