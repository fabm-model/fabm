...
#  define _INDEX_EXT_HORIZONTAL_SLICE_ (loop_start+_J_-1)
#  define _INDEX_EXT_HORIZONTAL_SLICE_PLUS_1_(i) (loop_start+_J_-1,i)
#  define _INDEX_EXT_HORIZONTAL_SLICE_PLUS_2_(i,j) (loop_start+_J_-1,i,j)
#else
...
#  define _HORIZONTAL_UNPACK_TO_PLUS_1_(in,i,out,j,env,missing) _CONCURRENT_HORIZONTAL_LOOP_BEGIN_EX_(env);out _INDEX_EXT_HORIZONTAL_SLICE_PLUS_1_(j) = in _INDEX_HORIZONTAL_SLICE_PLUS_1_(i);_HORIZONTAL_LOOP_END_
#  define _HORIZONTAL_UNPACK_AND_ADD_TO_PLUS_1_(in,i,out,j,env) _CONCURRENT_HORIZONTAL_LOOP_BEGIN_EX_(env);out _INDEX_EXT_HORIZONTAL_SLICE_PLUS_1_(j) = out _INDEX_EXT_HORIZONTAL_SLICE_PLUS_1_(j) + in _INDEX_HORIZONTAL_SLICE_PLUS_1_(i);_HORIZONTAL_LOOP_END_
