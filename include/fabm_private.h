...
#define _BEGIN_GLOBAL_LOOP_ do i__=istart__,istop__
...
#define _BEGIN_GLOBAL_LOOP_ do j__=jstart__,jstop__;do i__=istart__,istop__
#define _END_GLOBAL_LOOP_ end do;end do
...
#define _BEGIN_GLOBAL_LOOP_ do k__=kstart__,kstop__;do j__=jstart__,jstop__;do i__=istart__,istop__
#define _END_GLOBAL_LOOP_ end do;end do;end do
...
#  define _BEGIN_OUTER_VERTICAL_LOOP_ _BEGIN_GLOBAL_LOOP_
#  define _END_OUTER_VERTICAL_LOOP_ _END_GLOBAL_LOOP_
#else
...
#  define _DECLARE_HORIZONTAL_LOCATION_ integer :: _HORIZONTAL_LOCATION_
#else
...
#  define _DECLARE_HORIZONTAL_LOCATION_
#endif
...
#  define _POSTARG_HORIZONTAL_IN_ _POSTARG_HORIZONTAL_LOCATION_
...
#  define _UNPACK_TO_GLOBAL_SKIPMASK_(in,i,out,cache) out _INDEX_GLOBAL_INTERIOR_(cache%ipack(1:cache%n)) = in(1:cache%n,i)
#else
...
#  define _UNPACK_TO_GLOBAL_SKIPMASK_(in,i,out,cache) _UNPACK_TO_GLOBAL_(in,i,out,cache,dummy)
#endif
...
#    define _HORIZONTAL_UNPACK_TO_GLOBAL_SKIPMASK_(in,i,out,cache) out _INDEX_GLOBAL_HORIZONTAL_(cache%ipack(1:cache%n)) = in(1:cache%n,i)
#  else
...
#    define _HORIZONTAL_UNPACK_TO_GLOBAL_SKIPMASK_(in,i,out,cache) if (cache%n /= 0) then;out _INDEX_GLOBAL_HORIZONTAL_(_START_+_J_-1) = in _INDEX_HORIZONTAL_SLICE_PLUS_1_(i);end if
#  endif
#else
...
#  define _HORIZONTAL_UNPACK_TO_GLOBAL_SKIPMASK_(in,i,out,cache) _HORIZONTAL_UNPACK_TO_GLOBAL_SKIPMASK_(in,i,out,cache,dummy)
#endif
